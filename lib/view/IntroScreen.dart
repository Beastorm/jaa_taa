  ...
  void initState() {
    ...
    slides.add(
      new Slide(
        ...
        description: "Search anything from anywhere in Bangladesh",
        styleDescription: TextStyle(
            color: Color(0xff07AE76), fontSize: 18.0, fontFamily: 'Raleway'),
    ...
    slides.add(
      new Slide(
        ...
        styleTitle: TextStyle(
            ...
            fontWeight: FontWeight.bold,
            fontFamily: 'RobotoMono'),
        description: "Sell House, Car, Bike, Anything..",
        styleDescription: TextStyle(
            color: Color(0xff07AE76), fontSize: 18.0, fontFamily: 'Raleway'),
    ...
    slides.add(
      new Slide(
        ...
        styleTitle: TextStyle(
            ...
            fontFamily: 'RobotoMono'),
        description:
            "Buy anything, sell anything securely from anyone, to anyone",
        styleDescription: TextStyle(
            color: Color(0xff07AE76), fontSize: 18.0, fontFamily: 'Raleway'),
